var FullCalendar = (function (e) {
    ...
    function D(e, t, n, r, o, i, a, s, l, u) {
        ...
        for (n.__k = [], p = 0; p < t.length; p++)
            if (
                ...
                I(e, v, (h = h || c), o, i, a, s, l, u),
                    (y = v.__e),
                    (f = v.ref) && h.ref != f && (S || (S = []), h.ref && S.push(h.ref, null, v), S.push(f, v.__c || y, v)),
                    null != y
                        ? (null == b && (b = y),
        ...
        for (n.__e = b, p = D; p--;) null != w[p] && ("function" == typeof n.type && null != w[p].__e && w[p].__e == n.__d && (n.__d = E(r, p + 1)), A(w[p], w[p]));
                                        ...
                                        : ((n = (function (e, t) {
                                            ...
                                            $e(n)
                                                ...
                                                : ((n = (function (e, t) {
                                                    ...
                                                    $e(n) ? { unit: "second", value: n } : { unit: "millisecond", value: t.valueOf() - e.valueOf() })));
            }),
    ...
    var Lo = (function (e) {
        ...
        return (
            ...
            (t.prototype.safeSetState = function (e) {
                Ct(this.state, r(r({}, this.state), e), this.stateEquality) || this.setState(e);
            }),
        ...
        return (
            ...
            (t.prototype.render = function () {
                var e = this,
                    t = this.props,
                    n = t.hookProps;
                return Co($o, { hookProps: n, didMount: t.didMount, willUnmount: t.willUnmount, elRef: this.handleRootEl }, function (r) {
                    return Co(Xo, { hookProps: n, content: t.content, defaultContent: t.defaultContent, backupElRef: e.rootElRef }, function (e, o) {
    ...
    var ti = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return Co($o, { hookProps: r, didMount: n.viewDidMount, willUnmount: n.viewWillUnmount, elRef: e.elRef }, function (t) {
    ...
    function Ri(e, t) {
        for (var n = Dt(t.getCurrentData().eventSources), r = [], o = 0, i = e; o < i.length; o++) {
            ...
            (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
                ...
                for (var f in a)
                    a[f] === u[f] || (fn[f] && fn[f](a[f], u[f]))
                        ? (l[f] = c[f])
                        : (a[f] === this.currentCalendarOptionsInput[f] || (fn[f] && fn[f](a[f], this.currentCalendarOptionsInput[f]))
                ...
                (t.prototype.render = function () {
                    ...
                    return Co(Yo, { hookProps: d, classNames: a.dayHeaderClassNames, content: a.dayHeaderContent, defaultContent: Ea, didMount: a.dayHeaderDidMount, willUnmount: a.dayHeaderWillUnmount }, function (t, o, i, a) {
                        return Co(
                            ...
                            Co("div", { className: "fc-scrollgrid-sync-inner" }, Co("a", { "aria-label": n.format(s, Sa), className: ["fc-col-header-cell-cushion", e.isSticky ? "fc-sticky" : ""].join(" "), ref: i }, a))
                        );
                    });
                }),
                t
    ...
    var ts = (function (e) {
        function t() {
            ...
            return (
                ...
                (t.handleSizing = function () {
                    t.safeSetState(r({ shrinkWidth: t.computeShrinkWidth() }, t.computeScrollerDims()));
                }),
                t
            );
        }
        return (
            ...
            (t.prototype.renderSection = function (e, t, n) {
                return "outerContent" in e ? Co(_o, { key: e.key }, e.outerContent) : Co("tr", { key: e.key, role: "presentation", className: $a(e, this.props.liquid).join(" ") }, this.renderChunkTd(e, t, e.chunk, n));
            }),
        ...
        ss = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return Co(Xo, { hookProps: r, content: n.dayCellContent, defaultContent: e.defaultContent }, e.children);
                }),
                t
            );
        })(Uo);
    ...
    var us = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return Co($o, { hookProps: r, didMount: n.dayCellDidMount, willUnmount: n.dayCellWillUnmount, elRef: e.elRef }, function (t) {
    ...
    function fl(e, t, n, r, o, i, a) {
        ...
        for (
            ...
            for (var S = x.firstCol; S <= x.lastCol; S += 1) h[S].push({ seg: hl(x, S, S + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
        ...
        for (var w = 0, D = p; w < D.length; w++) {
            ...
            for (S = C.start; S < C.end; S += 1) (m[S] += 1), h[S].push({ seg: hl(x, S, S + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
                    ...
                    if (c)
                        for (var h = 0, v = t; h < v.length; h++) {
                            var g = v[h],
                                ...
                                w = "",
                                D = "";
                            S && (l.isRtl ? ((D = 0), (w = c.lefts[m.lastCol] - c.lefts[m.firstCol])) : ((w = 0), (D = c.rights[m.firstCol] - c.rights[m.lastCol]))),
                                f.push(
                                    Co(
                                        "div",
                                        {
                                            ...
                                            style: { visibility: b ? "" : "hidden", marginTop: S ? "" : g.marginTop, top: S ? g.absoluteTop : "", left: w, right: D },
                                        },
                                        il(m)
        ...
        Xl = (function (e) {
            ...
            return (
                ...
                (t.prototype.renderFgSegs = function (e, t, n, r, o) {
                    var i = this.props;
                    return i.forPrint ? Kl(e, i) : this.renderPositionedFgSegs(e, t, n, r, o);
                }),
                ...
                (t.prototype.renderFillSegs = function (e, t) {
                    var n = this.props,
                        ...
                        i = Gl(e, n.date, n.slatCoords, o.options.eventMinHeight).map(function (o, i) {
                            var a = e[i];
                            return Co("div", { key: ur(a.eventRange), className: "fc-timegrid-bg-harness", style: $l(o) }, "bg-event" === t ? Co(ds, r({ seg: a }, sr(a, n.todayRange, n.nowDate))) : cs(t));
                        });
                    return Co(_o, null, i);
                }),
            ...
            (t.prototype.queryHit = function (e, t) {
                ...
                if (null != p && null != f) {
                    var h = this.props.cells[p],
                        ...
                        S = o.add(E, b),
                        w = o.add(S, c);
                    return { dateProfile: s, dateSpan: r({ range: { start: S, end: w }, allDay: !1 }, h.extraDateSpan), dayEl: a.els[p], rect: { left: a.lefts[p], right: a.rights[p], top: v, bottom: v + g }, layer: 0 };
                }
                return null;
            }),
            t
