...
namespace ControlPortal.Persistence
{
    public static class ServiceRegistiration
    {
        ...
        public static void AddPersistenceServices(this IServiceCollection services)
        {
            ...
            services.AddDbContext<PortalDbContext>(options=>options.UseSqlServer("Server=Xlaner;Database=PortalDb;User Id=sa;Password=123456;Trusted_Connection=True;TrustServerCertificate=True;"));
