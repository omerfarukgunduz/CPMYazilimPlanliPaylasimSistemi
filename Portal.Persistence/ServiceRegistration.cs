...
namespace ControlPortal.Persistence
{
    public static class ServiceRegistiration
    {
        ...
        public static void AddPersistenceServices(this IServiceCollection services)
        {
            ...
            services.AddDbContext<PortalDbContext>(options=>options.UseSqlServer("Server=10.10.10.60;Database=PortalDb;User Id=sa;Password=123456;Trusted_Connection=True;TrustServerCertificate=True;"));

           

            services.AddScoped<ICelebrationDayReadRepository , CelebrationDayReadRepository>();
            services.AddScoped<ICelebrationDayWriteRepository , CelebrationDayWriteRepository>();
